...
mailloop = "select concat('ext_', b.rid, '@', a.mailloop_domain) from company_tbl a inner join mailloop_tbl b on a.company_id = b.company_id"
mailloop += " where forward_enable = 0 and ar_enable = 0 limit 1;"
